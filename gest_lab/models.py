...
class Solicitud(models.Model):
    ...
    solicitado_por = models.ForeignKey('Usuario', related_name='solicitado_por', on_delete=models.PROTECT)
    procesado_por = models.ForeignKey('Usuario',  related_name='procesado_por', on_delete=models.PROTECT, null=True, blank=True)
    validado_por = models.ForeignKey('Usuario', related_name='validado_por', on_delete=models.PROTECT, null=True, blank=True)
    entregado_por = models.ForeignKey('Usuario', related_name='entregado_por', on_delete=models.PROTECT, null=True, blank=True)
